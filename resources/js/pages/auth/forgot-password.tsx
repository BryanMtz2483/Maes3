...
export default function ForgotPassword({ status }: { status?: string }) {
    return (
        ...
        >
            ...
            {status && (
                <div className="mb-4 text-center text-sm font-medium text-green-400 bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                    {status}
                </div>
            )}
            ...
            <div className="space-y-6">
                ...
                <div className="space-x-1 text-center text-sm text-gray-400">
                    ...
                    <TextLink href={login()} className="text-yellow-400 hover:text-yellow-300 font-semibold">log in</TextLink>
                </div>
            </div>
        </AuthLayout>
    );
